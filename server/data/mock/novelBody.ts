...
export const mockNovelBody: NovelBodyEntity = {
  id: `${1}` as EntityId['novel'],
  workId: 1,
  title: '走れメロス',
  authorName: '太宰治',
  paragraphs: [
    {
      ...
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/01.png',
      },
      index: 1,
    },
    {
      content: '聞いて、メロスは激怒した。「呆あきれた王だ。生かして置けぬ。」\n',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/02.png',
      },
      index: 2,
    },
    {
    ...
    },
    {
      ...
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/04.png',
      },
      index: 4,
    },
    {
      content: 'メロスは口惜しく、地団駄じだんだ踏んだ。ものも言いたくなくなった。\n',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/05.png',
      },
      index: 5,
    },
    {
    ...
    {
      content:
        '時は刻々に過ぎて行きます。太陽も既に真昼時です。あれが沈んでしまわぬうちに、王城に行き着くことが出来なかったら、あの佳い友達が、私のために死ぬのです。」\n',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/01.png',
      },
    ...
    {
      content:
        '濁流は、メロスの叫びをせせら笑う如く、ますます激しく躍り狂う。浪は浪を呑み、捲き、煽あおり立て、そうして時は、刻一刻と消えて行く。今はメロスも覚悟した。泳ぎ切るより他に無い。ああ、神々も照覧あれ！',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/01.png',
      },
    ...
    {
      content:
        'ああ、もういっそ、悪徳者として生き伸びてやろうか。村には私の家が在る。羊も居る。妹夫婦は、まさか私を村から追い出すような事はしないだろう。正義だの、信実だの、愛だの、考えてみれば、くだらない。人を殺して自分が生きる。それが人間世界の定法ではなかったか。ああ、何もかも、ばかばかしい。私は、醜い裏切り者だ。どうとも、勝手にするがよい。やんぬる哉かな。――四肢を投げ出して、うとうと、まどろんでしまった。\n',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/01.png',
      },
    ...
    {
      content:
        '殺されるのは、私だ。メロスだ。彼を人質にした私は、ここにいる！」と、かすれた声で精一ぱいに叫びながら、ついに磔台に昇り、釣り上げられてゆく友の両足に、齧かじりついた。群衆は、どよめいた。あっぱれ。ゆるせ、と口々にわめいた。セリヌンティウスの縄は、ほどかれたのである。\n「セリヌンティウス。」メロスは眼に涙を浮べて言った。「私を殴れ。ちから一ぱいに頬を殴れ。私は、途中で一度、悪い夢を見た。君が若もし私を殴ってくれなかったら、私は君と抱擁する資格さえ無いのだ。殴れ。」\n',
      image: {
        url: 'https://placehold.jp/3d4070/ffffff/160x90.png?text=%E8%B5%B0%E3%82%8C%E3%83%A1%E3%83%AD%E3%82%B9',
        s3Key: 'novels/1/01.png',
      },
  ...
  aozoraUrl: 'https://www.aozora.gr.jp/cards/000035/files/1567_14913.html',
};
